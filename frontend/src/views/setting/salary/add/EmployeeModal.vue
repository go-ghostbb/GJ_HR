...
<script lang="ts" setup>
  ...
  import { setSalaryAddItemEmployee } from '@/api/setting/salaryItem';
  ...
  const handleOk = async () => {
    try {
      ...
      await setSalaryAddItemEmployee(addItemId.value, empIDs);
      emit('success');
      closeModal();
    } finally {
